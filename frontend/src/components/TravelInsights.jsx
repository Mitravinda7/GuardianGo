  ...
  return (
    <>
      <style>{`
        ...
        .ti-card-type {
          font-size: 0.74rem; color: #666666;
        ...
        .ti-card-hours {
          font-size: 0.72rem; color: #888888;
          display: flex; align-items: flex-start;
        ...
        .ti-loading {
          ...
          color: #666666; font-size: 0.88rem;
        }
        .ti-spinner {
        ...
        .ti-empty {
          ...
          color: #888888; font-size: 0.88rem;
        }
        ...
        {!loading && places.length > 0 && (
          <div className="ti-meta">
            <span style={{
              ...
              background: activeCat?.color, display: 'inline-block',
            }} />
                ...
                >
                  <div className="ti-card-body">
                    <div className="ti-card-top">
                      ...
                      <div className="ti-card-dist" style={{ background: distColor }}>
                        {dist} km
                      </div>
                    </div>
                    <div className="ti-card-type">
                      {activeCat?.icon} {place.type?.replace(/_/g, ' ')}
                    </div>
                    {place.opening_hours && (
                      <div className="ti-card-hours">
                        🕐 {place.opening_hours.length > 30
                          ? place.opening_hours.slice(0, 30) + '...'
                          : place.opening_hours}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="ti-card-actions">
                    <button
                      className="ti-action-btn primary"
